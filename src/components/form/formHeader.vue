<template>
  <div id="header" style="padding: 20px">
    ...
    <form role="form">
      ...
      <div class="form-group">
        ...
        <div class="" style="float: left">
          ...
          <input type="date" id="beginTime" class="form-control" v-model="beginTime" style="width: 450px">
        </div>
        <div class="form-group" style="float: right">
          <label for="deadLine"><span style="color: red">*</span>截止时间:</label>
          <input type="date" id="deadLine" class="form-control" v-model="deadLine" style="width: 450px">
        </div>
    ...
    <div class="form-group" id="buttons">
      ...
      <input type="reset" value="重置" id="reset_button" class="btn btn-danger" @click="resetData">
    </div>
  </div>
</template>
